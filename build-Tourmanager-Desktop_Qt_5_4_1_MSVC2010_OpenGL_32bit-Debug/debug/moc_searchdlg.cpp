...
#include "../../Tourmanager/searchdlg.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SearchDlg_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SearchDlg_t qt_meta_stringdata_SearchDlg = {
    {
QT_MOC_LITERAL(0, 0, 9), // "SearchDlg"
QT_MOC_LITERAL(1, 10, 22), // "on_sTbtnSearch_clicked"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "SearchDlg\0on_sTbtnSearch_clicked\0"
};
...
void SearchDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_sTbtnSearch_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *SearchDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SearchDlg.stringdata))
